                ...
                <flux:table.row :key="$item->id">
                            ...
                            <flux:table.cell>
                                @switch($cfg['type'])
                                    @case('switch')
                                        ...
                                        @break
                                    @case('select')
                                        @if($field === 'cycle_unit' && $item->$field)
                                        ...
                                        @elseif($field === 'salary_cycle_id' && $item->$field)
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $item->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Salary Cycle?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this salary cycle. This action cannot be undone.</p>
                                        <p class="mt-2 text-red-500">Note: Salary cycles with related records cannot be deleted.</p>
                                    </flux:text>
                                </div>
