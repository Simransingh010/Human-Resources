<div class="space-y-6">
    ...
    <div class="flex justify-between">
        ...
        <flux:modal.trigger name="mdl-salary-template" class="flex justify-end">
    ...
    <!-- Add/Edit Salary Template Modal -->
    <flux:modal name="mdl-salary-template" @cancel="resetForm">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Salary Template @else Add Salary Template @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif salary template details.
                    </flux:subheading>
                </div>
                ...
                <flux:table.row :key="$item->id">
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $item->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Salary Template?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this salary template. This action cannot be undone.</p>
                                        <p class="mt-2 text-red-500">Note: Salary templates with related records cannot be deleted.</p>
                                    </flux:text>
                                </div>
