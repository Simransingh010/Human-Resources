<div class="space-y-6">
    ...
    <div class="flex justify-between">
        ...
        <flux:modal.trigger name="mdl-salary-component-group" class="flex justify-end">
    ...
    <!-- Add/Edit Salary Component Group Modal -->
    <flux:modal name="mdl-salary-component-group" @cancel="resetForm">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Salary Component Group @else Add Salary Component Group @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif salary component group details.
                    </flux:subheading>
                </div>
                ...
                <flux:table.row :key="$item->id">
                        ...
                        @if(in_array($field, $visibleFields))
                            <flux:table.cell>
                                @switch($cfg['type'])
                                    ...
                                    @case('select')
                                        @if($field === 'parent_salary_component_group_id')
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $item->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Salary Component Group?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this salary component group. This action cannot be undone.</p>
                                        <p class="mt-2 text-red-500">Note: Salary component groups with related records cannot be deleted.</p>
                                    </flux:text>
                                </div>
