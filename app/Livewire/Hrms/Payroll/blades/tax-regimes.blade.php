<div class="space-y-6">
    ...
    <div class="flex justify-between">
        ...
        <flux:modal.trigger name="mdl-tax-regime" class="flex justify-end">
    ...
    <!-- Add/Edit Tax Regime Modal -->
    <flux:modal name="mdl-tax-regime" @cancel="resetForm">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Tax Regime @else Add Tax Regime @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif tax regime details.
                    </flux:subheading>
                </div>
                ...
                <flux:table.row :key="$item->id">
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $item->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Tax Regime?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this tax regime. This action cannot be undone.</p>
                                        <p class="mt-2 text-red-500">Note: Tax regimes with related records cannot be deleted.</p>
                                    </flux:text>
                                </div>
