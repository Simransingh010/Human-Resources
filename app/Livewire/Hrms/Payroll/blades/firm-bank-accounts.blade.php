<div class="space-y-6">
    ...
    <div class="flex justify-between">
        ...
        <flux:modal.trigger name="mdl-firm-bank-account" class="flex justify-end">
    ...
    <flux:modal name="mdl-firm-bank-account" @cancel="resetForm">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    ...
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif bank account details.
                    </flux:subheading>
                </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this bank account. This action cannot be undone.</p>
                                        <p class="mt-2 text-red-500">Note: Bank accounts with related records cannot be deleted.</p>
                                    </flux:text>
                                </div>
