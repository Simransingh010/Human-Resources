<div class="space-y-6">
    ...
    <div class="flex justify-between">
        ...
        <flux:modal.trigger name="mdl-department-rule" class="flex justify-end">
    ...
    <!-- Add/Edit Department Rule Modal -->
    <flux:modal name="mdl-department-rule" @cancel="resetForm">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Department Rule @else Add Department Rule @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif department leave approval rule details.
                    </flux:subheading>
                </div>
                ...
                <flux:table.row :key="$item->id">
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $item->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Department Rule?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this department leave approval rule. This action cannot be undone.</p>
                                    </flux:text>
                                </div>
