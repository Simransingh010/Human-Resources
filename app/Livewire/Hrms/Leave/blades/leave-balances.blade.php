<div class="space-y-6">
    ...
    <flux:modal name="leave-transactions" title="Leave Transactions" class="max-w-none">
        @if($selectedId)
            <livewire:hrms.attendance-meta.emp-leave-transactions :bala-id="$selectedId"
                                                        :wire:key="'leave-transactions-'.$selectedId"/>
        @endif
    </flux:modal>
</div> 