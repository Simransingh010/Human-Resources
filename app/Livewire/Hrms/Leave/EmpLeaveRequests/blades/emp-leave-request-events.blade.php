            ...
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Leave Request Event @else Add Leave Request Event @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif leave request event details.
                    </flux:subheading>
                </div>
                ...
                <flux:table.row :key="$item->id">
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $item->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Leave Request Event?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this leave request event. This action cannot be undone.</p>
                                    </flux:text>
                                </div>
