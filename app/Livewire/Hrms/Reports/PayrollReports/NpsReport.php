...
use App\Livewire\Hrms\Reports\PayrollReports\exports\NpsReportExport;
...
class NpsReport extends Component
{
    ...
    public function export()
    {
        ...
        // Add firm name to filters for export header if needed
        $this->filters['firm_name'] = session('firm_name') ?? '';

        return Excel::download(
            new NpsReportExport($this->filters),
            $filename
        );
    }
    ...
    {
        return view()->file(app_path('Livewire/Hrms/Reports/PayrollReports/blades/nps-report.blade.php'));
    }
}
