<div class="space-y-6">
    <flux:heading size="lg">TDS Report</flux:heading>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Date Range -->
        <flux:date-picker label="TDS Period" with-today mode="range" with-presets wire:model="filters.date_range" />
        ...
        <!-- Employment Type -->
        <flux:select label="Employment Type" variant="listbox" multiple searchable
            wire:model.defer="filters.employment_type_id">
            <flux:select.option value="">All</flux:select.option>
        ...
        <flux:select label="Salary Execution Group" variant="listbox"
            wire:model.defer="filters.salary_execution_group_id">
            <flux:select.option value="">All</flux:select.option>
