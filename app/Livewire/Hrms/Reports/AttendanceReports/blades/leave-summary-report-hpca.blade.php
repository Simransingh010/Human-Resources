<div class="space-y-6">
    <flux:heading size="lg">HPCA Leave Summary (date-wise)</flux:heading>

    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <!-- Date Range -->
        <flux:date-picker label="Report Period" with-today mode="range" with-presets wire:model="filters.date_range" />
