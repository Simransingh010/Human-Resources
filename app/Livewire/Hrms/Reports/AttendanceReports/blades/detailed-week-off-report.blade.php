<div class="space-y-6">
    <flux:heading size="lg">Detailed Week Off Report</flux:heading>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Date Range -->
        <flux:date-picker label="Week Off Period" with-today mode="range" with-presets wire:model="filters.date_range" />
