        ...
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                    <flux:input label="Title" wire:model="formData.title" placeholder="Calendar Title"/>
                    <flux:textarea label="Description" wire:model="formData.description" placeholder="Calendar Description"/>
