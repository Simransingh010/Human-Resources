<div class="space-y-6">
    ...
    <div class="flex justify-between">
        ...
        <flux:modal.trigger name="mdl-agency" class="flex justify-end">
    ...
    <flux:modal name="mdl-agency" @cancel="resetForm">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Agency @else Add Agency @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif agency details.
                    </flux:subheading>
                </div>
                ...
                <flux:table.row :key="$item->id">
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $item->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Agency?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this agency. This action cannot be undone.</p>
                                    </flux:text>
                                </div>
