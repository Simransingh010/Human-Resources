<div class="space-y-6 max-w-7xl">
    <div>
        <flux:heading size="lg">{{ $role->name }} @if(!$role->firm_id)<span class="text-blue-600">(Global Role)</span>@endif</flux:heading>
        <flux:text class="text-gray-500">Assign actions to this @if(!$role->firm_id)global @endif role</flux:text>
    </div>
