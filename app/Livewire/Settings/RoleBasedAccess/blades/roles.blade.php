<div class="space-y-6">
    ...
    <!-- Add/Edit Role Modal -->
    <flux:modal name="mdl-role" @cancel="resetForm" class="max-w-3xl">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Role @else Add Role @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif role details.
                    </flux:subheading>
                </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this role. This action cannot be undone.</p>
                                        <p class="mt-2 text-red-500">Note: Roles with assigned users or actions cannot be deleted.</p>
                                    </flux:text>
                                </div>
