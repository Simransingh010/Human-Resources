<div>
    ...
    <div class="flex justify-between">
        ...
        <flux:modal.trigger name="mdl-designation" class="flex justify-end">
    ...
    <!-- Modal Start -->
    <flux:modal name="mdl-designation" @cancel="resetForm" position="right" class="max-w-none" variant="flyout">
        <form wire:submit.prevent="store">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Designation @else Add Designation @endif
                    </flux:heading>
                    <flux:subheading>
                        @if($isEditing) Update @else Add new @endif designation details.
                    </flux:subheading>
                </div>

                <!-- Grid layout for form fields -->
                <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                    <flux:input label="Title" wire:model="formData.title" placeholder="Designation Title"/>
                ...
                <flux:table.row :key="$rec->id" class="border-b">
                    ...
                    <flux:table.cell>
                        ...
                        <flux:modal name="delete-{{ $rec->id }}" class="min-w-[22rem]">
                            <div class="space-y-6">
                                <div>
                                    <flux:heading size="lg">Delete Designation?</flux:heading>
                                    <flux:text class="mt-2">
                                        <p>You're about to delete this designation. This action cannot be undone.</p>
                                    </flux:text>
                                </div>
