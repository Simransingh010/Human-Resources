<div>
    ...
    <!-- Modal Start -->
    <flux:modal name="mdl-joblocation" @cancel="resetForm" position="right" class="md:w-96" variant="default">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <flux:input 
                            ...
                            class="@error('formData.name') border-red-500 @enderror"
                        />
                        @error('formData.name')
                    ...
                    <div>
                        <flux:input 
                            ...
                            placeholder="Job Location Code"
                            class="@error('formData.code') border-red-500 @enderror"
                        />
                        @error('formData.code')
                            <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        <flux:input 
                            ...
                            class="@error('formData.description') border-red-500 @enderror"
                        />
                    ...
                    <div class="relative">
                        ...
                        <select
                            ...
                            class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-2 py-2 @error('formData.parent_joblocation_id') border-red-500 @enderror"
                        >
                        ...
                        @error('formData.parent_joblocation_id')
                            <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <select
                            ...
                            wire:change="triggerUpdate('citychanged')"
                            class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-2 py-2"
                        >
                    ...
                    <div>
                        <flux:switch 
                            wire:model="formData.is_inactive"
                            label="Mark as Inactive"
                            class="@error('formData.is_inactive') border-red-500 @enderror"
                        />
