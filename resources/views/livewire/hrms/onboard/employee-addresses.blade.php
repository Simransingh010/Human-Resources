<div>
    <flux:modal.trigger name="mdl-address">
        <flux:button variant="primary" wire:click="resetForm()"
            class="bg-blue-500 text-white px-4 py-2 mb-4 rounded-md">
            Add Address
        </flux:button>
    </flux:modal.trigger>
        ...
        <form wire:submit.prevent="saveAddress">
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <flux:select label="Select Employee" wire:model="addressData.employee_id"
                    ...
                    <flux:table.cell>
                        <div class="flex items-center space-x-2">
                            <flux:switch wire:model="addressStatuses.{{ $address->id }}"
                                wire:click="update_rec_status({{$address->id}})" :checked="!$address->is_inactive" />
                        </div>
                    </flux:table.cell>
                    <flux:table.cell>
