<div>
    <flux:modal.trigger name="mdl-contact">
        <flux:button variant="primary" class="bg-blue-500 text-white px-4 py-2 rounded-md mb-4">
            @if($isEditing)
                Edit Contact
            @else
                Add Contact
            ...
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        @if($isEditing) Edit Contact @else Add Contact @endif
                    </flux:heading>
                    <flux:subheading>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <flux:select label="Select Employee" wire:model="contactData.employee_id"
                    ...
                    <flux:input label="Contact Value" wire:model="contactData.contact_value"
    ...
    <flux:table :paginate="$this->contactsList" class="w-full">
